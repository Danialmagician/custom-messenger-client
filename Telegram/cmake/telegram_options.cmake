...
if (DESKTOP_APP_CUSTOM_BACKEND)
    if (TDESKTOP_API_ID STREQUAL "0" OR TDESKTOP_API_HASH STREQUAL "")
        set(TDESKTOP_API_ID 0)
        set(TDESKTOP_API_HASH "00000000000000000000000000000000")
    endif()
elseif (TDESKTOP_API_TEST)
    set(TDESKTOP_API_ID 17349)
    set(TDESKTOP_API_HASH 344583e45741c457fe1862106095a5eb)
endif()

if (NOT DESKTOP_APP_CUSTOM_BACKEND)
    if (TDESKTOP_API_ID STREQUAL "0" OR TDESKTOP_API_HASH STREQUAL "")
        message(FATAL_ERROR
        " \n"
